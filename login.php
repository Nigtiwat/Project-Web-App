   ...
   <div class="contact-infhny py-5">
     <div class="container py-lg-3">
       <div class="top-map">
         ...
         <div class="form-top1">
         <h3 class="title-big text-center mb-2">Login</h3>
         <p class="mb-lg-5 mb-4 text-center">ยินดีต้อนรับโปรดป้อนข้อมูลเพื่อดำเนินการต่อ</p>
        ...
        <div class="form-top">
                   ...
                   <label for="Plassword">Password</label>
                   <input class="form-control" type="password" name="password"  placeholder="รหัสผ่าน" > 
                   <label for="name">Not yet a member?<a href="register.php">Sign up</a></label>                              
                 <div class="form-top-righ">
                  <button type="submit" class="btn btn-style btn-primary" name="login_user">Login</button>
                 </div>
               </div>
